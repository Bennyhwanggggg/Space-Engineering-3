%% function Keplerian model
%
% Author Kuan Chun Hwang

function [pos_eci, pos_llhgc, pos_ecef] = keplerian(n_sat,a,e,i_deg, cap_omega_deg, omega_deg, M_deg,Epoc_time,times,t_vernal)
...
i_rad = deg2rad(i_deg);
cap_omega_rad = deg2rad(cap_omega_deg);
M_rad = deg2rad(M_deg);
